        ...
        <div className="flex flex-col h-full">
            ...
            <div className="flex-1 relative">
                ...
                <div className="absolute inset-0 overflow-hidden pointer-events-none">
                    ...
                    <div
                        className="absolute bottom-1/3 right-1/4 w-[500px] h-[500px] bg-accent/10 rounded-full blur-3xl animate-pulse"
                        style={{animationDelay: "1s"}}/>
                </div>

                <div className="space-y-6 py-6 px-6 overflow-y-scroll fixed top-18 z-[50] h-screen pb-40 left-0 right-0"
                    ...
                    <div className="max-w-4xl mx-auto">
                        {messages.length === 0 && !currentAssistantMessage && (
                            <div className="flex-1 flex items-start justify-center pt-20">
                                <div className="flex flex-col items-center text-center gap-5">
                                    <div
                                        className="w-20 h-20 rounded-2xl bg-gradient-primary flex items-center justify-center shadow-glow animate-float">
                                        <svg
                                    ...
                                    <div className="space-y-3 animate-chat-rise">
                                        ...
                                        <p className="text-muted-foreground max-w-md mx-auto">
                                            Start a conversation with Google's most advanced AI models. Ask anything,
                                            explore ideas, or build something amazing.
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        {currentAssistantMessage && (
                            <div className="flex w-full justify-start animate-scale-in">
                                <div className="flex items-start gap-3 max-w-[min(85%,620px)]">
                                    <div
                                        className="w-8 h-8 rounded-full bg-gradient-accent flex items-center justify-center text-white text-sm font-medium">
                                        AI
                                    </div>
                                    <Card ref={streamingAssistantRef}
                                          className="border px-5 py-4 rounded-2xl shadow-sm bg-card/90 border-border">
                                        <Suspense fallback={<MessageContentFallback/>}>
                        ...
                        {isStreaming && !currentAssistantMessage && (
                            <div className="flex w-full justify-start animate-fade-in">
                                <div className="flex items-start gap-3 max-w-[min(85%,620px)]">
                                    <div
                                        className="w-8 h-8 rounded-full bg-gradient-accent flex items-center justify-center animate-pulse-glow">
                                    ...
                                    <Card ref={streamingAssistantRef}
                                        ...
                                        {isThinking ? (
                                            <div className="flex items-center gap-2">
                                                ...
                                                <span
                                                    className="text-sm text-muted-foreground italic">Thinking...</span>
                                            </div>
                                        ) : (
                                            <div className="flex gap-1">
                        ...
                        {thoughtSummaries.length > 0 && (
                            <div className="flex w-full justify-start animate-fade-in">
                                <div className="flex items-start gap-3 max-w-[min(85%,620px)]">
                                    ...
                                    <Card
                                        className="border px-5 py-4 rounded-2xl shadow-sm bg-primary/5 border-primary/20">
            ...
            {/* Sticky input area */}
            <div className="fixed bottom-0 left-0 right-0 pointer-events-none z-[100]">
                <div className="max-w-4xl mx-auto w-full space-y-3 pointer-events-auto px-6 py-4">
                    ...
                    {attachedFiles.length > 0 && (
                        <div className="flex flex-wrap justify-center gap-2">
                            {attachedFiles.map((file, index) => (
                                <div key={index}
                                     className="flex items-center gap-2 rounded-full border border-primary/30 bg-primary/10 px-3 py-1.5 backdrop-blur">
                    ...
                    <div className="relative">
                        ...
                        />
                        <div
                            className="flex items-center gap-2 rounded-full border border-primary/30 bg-card/95 px-3 py-1.5 shadow-glow backdrop-blur supports-[backdrop-filter]:backdrop-blur-md">
                            <Button
                                variant="ghost"
                                size="icon"
